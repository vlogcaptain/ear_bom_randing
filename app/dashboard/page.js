                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
                        <div className="bg-white p-6 rounded-3xl border border-slate-200 shadow-sm relative overflow-hidden group">
                            <div className="flex items-center justify-between mb-4">
                                ...
                                <span className="text-xs font-bold text-blue-500 bg-blue-50 px-2.5 py-1 rounded-full">+1 new</span>
                            </div>
                            <p className="text-slate-500 text-sm font-medium">최근 진단 점수</p>
                            <h3 className="text-2xl font-black text-slate-800 mt-1">88점</h3>
                        </div>
